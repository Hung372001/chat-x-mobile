...
const documentPreview = ({
  ...
  const openDocument = () => {
    let uri = srcData[0].file;
    if (Platform.OS === "ios") {
      uri = srcData[0].file;
    }
    FileViewer.open(timeData == "" ? srcData[0].uri : srcData[0].file)
      .then(() => {
      })
      .catch((err) => {
      });
    ...
    >
      <TouchableOpacity
        ...
        style={{
          ...
          shadowOpacity: 0.1,
          paddingHorizontal: 5,
          paddingVertical: replyType ? 0 : 10,
        }}
      >
          ...
          <>
            {sender != true && chatType == 2 && (
              <Text
                style={{
                  paddingBottom: 5,
                  marginHorizontal: replyType ? 0 : 7,
            ...
            {data_item.replyMessage.messageType == "0" ? (
              ...
              >
                ...
                <View style={{ width: "88%" }}>
                  <MediaMessage
                    srcData={data_item.replyMessage.attachmentsData.attachments}
                    timeData={data_item.timeStamp}
                    sender={data_item.isSender}
                    replyType={true}
                  />
                ...
                <View style={{ width: "88%" }}>
                  ...
                  >
                    ...
                    />
                      ...
                      >
                        {data_item.replyMessage.attachmentsData.attachments[0]
                          .fileName.length > 25
                          ? data_item.replyMessage.attachmentsData.attachments[0].fileName.substring(
                              0,
                              25
                            ) + " ..."
        ...
        {reply == null && sender != true && chatType == 2 && (
          <Text
            style={{
              marginHorizontal: replyType ? 0 : 5,
              fontFamily: "Urbanist-Bold",
              lineHeight: 22,
              fontSize: 15,
              letterSpacing: 0.5,
        ...
        >
          <Feather
            style={{ paddingLeft: replyType ? 0 : 5 }}
            name={"file"}
            type={"file"}
            color={settings.chatSetting.secondaryColor}
            size={20}
          ...
          timeData == "" ? (
            ...
            >
              {srcData[0].name.length > 25
                ? srcData[0].name.substring(0, 25) + " ..."
                : srcData[0].name}
            </Text>
          ) : (
            <Text
            ...
            >
              {srcData[0].fileName.length > 25
                ? srcData[0].fileName.substring(0, 25) + " ..."
                : srcData[0].fileName}
            </Text>
          )
            :<Text
